				...
				<div class="inner">
					<nav id="tmMainNav" class="tm-main-nav">
						<ul>
							...
							<li>
								<a href="#contact">
									<span onclick="window.location.href='php/sair.php'">Logout</span>
								</a>
							</li>
						</ul>
					</nav>
			...
			<div class="col-xl-9 col-lg-8 col-md-12 col-sm-12 tm-content">
					...
					<section id="tm-section-4" class="tm-section">
						<div class="tm-bg-transparent-black tm-contact-box-pad">
							<div class="row mb-4">
								<div class="col-sm-12">
									<header><h2 class="tm-text-shadow" align="center">Painel De Usuário</h2></header>
								</div>
							</div>
							<div class="row tm-page-4-content">
								<div class="col-md-6 col-sm-12 tm-contact-col">
									...
									<form align="center" action="php/update.php" method="POST"  class="contact-form">
										<div class="form-group">
                                            <input style="width:500px; " type="email" name="login" class="form-control" placeholder="Digite seu novo Email" required>
                                        </div>
									

                                        <div class="form-group">
                                            <input style="width:500px;" type="password" name="senha" class="form-control" placeholder="Digite sua nova Senha" required>
                                        </div>

										<table>
										<th>	
											<button style="margin-top:2px;" class="btn tm-btn" onclick="window.location.href='php/update.php'" >Redefinir Usuário</button> 
										</th>
										</form>
										<th>								
											<button style="margin-left:5px; color:red;" onclick="window.location.href='php/delete.php'" title="Tem certeza???"class="btn tm-btn" type="submit">Deletar Usuário</button>
										</th>
										</table> 			
									</div>
								</div>
